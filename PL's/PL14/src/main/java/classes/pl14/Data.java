...
public class Data implements Comparable<Data> {
    ...
    private static enum DiaDaSemana {
        ...
        /**
         * Devolve a designação do dia da semana cuja ordem é recebida por parâmetro.
         *
    ...
    /**
     * Constrói uma instância de Data com as mesmas caraterísticas da data recebida por parâmetro.
     *
    ...
    public final void setData(int ano, int mes, int dia) {
        if (mes < 1 || mes > 12) {
            ...
            throw new MesInvalidoException(mes + "Mês " + "é inválido!");
        }
        if (dia < 1 || dia > Mes.obterMes(mes).numeroDeDias(ano)) {

            throw new DiaInvalidoException("Dia " +dia+ "/" + mes + "/" + ano + " é Inválido!!");
        }
    ...
    /**
     * Devolve a descrição textual da data no formato: diaDaSemana, dia de mês de ano.
     *
     ...
     * @return true se o objeto recebido representar uma data equivalente à data. Caso contrário, retorna false.
     */
    @Override
     ...
     * @return o valor 0 se a outraData recebida é igual à data; o valor -1 se a outraData for posterior à data; o valor 1 se a outraData for anterior à data.
     */
    @Override
    ...
    /**
     * Devolve true se a data for maior do que a data recebida por parâmetro. Se a data for menor ou igual à data recebida por parâmetro, devolve false.
     *
    ...
    /**
     * Devolve a diferença em número de dias entre a data e a data recebida por parâmetro.
     *
    ...
    /**
     * Devolve a diferença em número de dias entre a data e a data recebida por parâmetro com ano, mês e dia.
     *
    ...
    /**
     * Devolve true se o ano passado por parâmetro for bissexto. Se o ano passado por parâmetro não for bissexto, devolve false.
     *
