...
public class RegisterEmployeeUI {
    ...
    public RegisterEmployeeUI(MainApp mainApp) {
    ...
    public void toRegisterEmployeeScene1() {
        try {
            ...
            Employee employee = this.controller.getEmployee();
            registerEmployeeScene1UI.initComboBox();
            if (employee != null) {
                registerEmployeeScene1UI.showEmployee(employee);
            }
...
//    public void toRegisterEmployeeScene2(Employee employee) {
...
//            registerEmployeeScene2UI.showEmployee(employee);
